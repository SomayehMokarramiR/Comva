...
function Section1() {
  return (
    <div className="mt-[100px] md:mt-[135px]">
      <H1 size="32" sizemd="44">
      ...
      <p className="mt-10 text-center text-[14px] leading-[180%] font-[300] text-[#171F26] md:text-[16px] md:font-normal">
